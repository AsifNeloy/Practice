...
void initGL() {
	...
	glClearColor(0.0f, 0.0f, 0.5f, 0.0f); // White and opaque
...
void Stars()
{
	 ...
	 glColor3ub(255,231,3); // Red
	glVertex2f(-90.0f, 60.0f);    // x, y
	glEnd();
          glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3);
	glVertex2f(-95.0f, 85.0f);    // x, y
	glEnd();
	glPointSize(3.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-80.0f, 75.0f);    // x, y
	glEnd();
	glPointSize(3.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-65.0f, 65.0f);    // x, y
	glEnd();
	glPointSize(5.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-55.0f, 85.0f);    // x, y
	glEnd();
	glPointSize(5.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-45.0f, 90.0f);    // x, y
	glEnd();
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-55.0f, 60.0f);    // x, y
	glEnd();
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-40.0f, 45.0f);    // x, y
	glEnd();
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-30.0f, 75.0f);    // x, y
	glEnd();
	glPointSize(3.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-25.0f, 45.0f);    // x, y
	glEnd();
	glPointSize(3.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-28.0f, 25.0f);    // x, y
	glEnd();
	glPointSize(3.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	...
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-15.0f, 65.0f);    // x, y
	glEnd();
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-20.0f, 45.0f);    // x, y
	glEnd();
	glPointSize(3.0);
	glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-13.0f, 15.0f);    // x, y
	glEnd();
	glPointSize(4.0);
	glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-3.0f, 35.0f);    // x, y
	glEnd();
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-5.0f, 70.0f);    // x, y
	glEnd();
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(-0.0f, 85.0f);    // x, y
	glEnd();
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(9.0f, 65.0f);    // x, y
	glEnd();
	glPointSize(3.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	...
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(25.0f, 75.0f);    // x, y
	glEnd();
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(35.0f, 55.0f);    // x, y
	glEnd();
	glPointSize(3.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(38.0f, 25.0f);    // x, y
	glEnd();
	glPointSize(3.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(43.0f, 5.0f);    // x, y
	glEnd();
	glPointSize(5.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(45.0f, 87.0f);    // x, y
	glEnd();
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(53.0f, 55.0f);    // x, y
	glEnd();
	glPointSize(3.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(57.0f, 25.0f);    // x, y
	glEnd();
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(63.0f, 65.0f);    // x, y
	glEnd();
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	...
	glPointSize(3.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(75.0f, 15.0f);    // x, y
	glEnd();
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(85.0f, 45.0f);    // x, y
	glEnd();
	glPointSize(5.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(85.0f, 75.0f);    // x, y
	glEnd();
	glPointSize(4.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(95.0f, 55.0f);    // x, y
	glEnd();
	glPointSize(3.0);
          glBegin(GL_POINTS);              // Each set of 4 vertices form a quad
	glColor3ub(255,231,3); // Red
	glVertex2f(93.0f, 25.0f);    // x, y
	glEnd();
}
void MovingStar()
{
